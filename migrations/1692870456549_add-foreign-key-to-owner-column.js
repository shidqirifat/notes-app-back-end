...
exports.up = (pgm) => {
  ...
  // memberi constraint foreign key pada owner terhadap kolom id dari table users
  pgm.addConstraint('notes', 'fk_notes.owner_user_id', 'FOREIGN KEY(owner) REFERENCES users(id)');
};
